...
const createLights = () => {
    hemisphereLight = new THREE.HemisphereLight(0x3b82f6, 0x000000, 0.5);
    ...
    light2 = new THREE.DirectionalLight(0x3b82f6, 0.25);
    light2.position.set(-600, 350, 350);

    light3 = new THREE.DirectionalLight(0xff0066, 0.15);
